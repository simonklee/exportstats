...
curl -i "http://localhost:6070/v1/exportstats/nrate/?stat=eu.website.load.webgl.win7.ch.launch.cnt&stat=eu.u.webgl.win7.ch.Playing&t=6h1h&format=json&start=1464156000000"
