...
curl -i "http://localhost:6070/v1/exportstats/nrate/?stat=eu.website.load.webgl.embed.win7.ch.download.cnt&stat=eu.website.load.webgl.embed.win7.ch.postdownload.cnt&t=6h1h&format=json&start=1464156000000"
